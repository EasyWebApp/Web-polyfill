(function() {
  ...
  var require_utils = __commonJS({
    "bazel-out/darwin-fastbuild/bin/packages/ecma402-abstract/utils.js": function(exports) {
      ...
      function invariant5(condition, message, Err) {
        if (Err === void 0) {
          Err = Error;
        }
        if (!condition) {
  ...
  function InitializeRelativeTimeFormat(rtf, locales, options, _a) {
    ...
    var opt = /* @__PURE__ */ Object.create(null);
    var opts = (0, import_ecma402_abstract.CoerceOptionsToObject)(options);
    var matcher = (0, import_ecma402_abstract.GetOption)(opts, "localeMatcher", "string", ["best fit", "lookup"], "best fit");
    opt.localeMatcher = matcher;
    var numberingSystem = (0, import_ecma402_abstract.GetOption)(opts, "numberingSystem", "string", void 0, void 0);
    ...
    internalSlots.style = (0, import_ecma402_abstract.GetOption)(opts, "style", "string", ["long", "narrow", "short"], "long");
    internalSlots.numeric = (0, import_ecma402_abstract.GetOption)(opts, "numeric", "string", ["always", "auto"], "always");
    var fields = localeData[r.dataLocale];
    (0, import_ecma402_abstract.invariant)(!!fields, "Missing locale data for ".concat(r.dataLocale));
  ...
  function SingularRelativeTimeUnit(unit) {
    (0, import_ecma402_abstract2.invariant)((0, import_ecma402_abstract2.Type)(unit) === "String", "unit must be a string");
    if (unit === "seconds")
      return "second";
    if (unit === "minutes")
      return "minute";
  ...
  function MakePartsList(pattern, unit, parts) {
    var patternParts = (0, import_ecma402_abstract3.PartitionPattern)(pattern);
    var result = [];
    for (var _i = 0, patternParts_1 = patternParts; _i < patternParts_1.length; _i++) {
      ...
      if (patternPart.type === "literal") {
        ...
        (0, import_ecma402_abstract3.invariant)(patternPart.type === "0", "Malformed pattern ".concat(pattern));
  ...
  function PartitionRelativeTimePattern(rtf, value, unit, _a) {
    var getInternalSlots2 = _a.getInternalSlots;
    (0, import_ecma402_abstract4.invariant)((0, import_ecma402_abstract4.Type)(value) === "Number", "value must be number, instead got ".concat(typeof value), TypeError);
    (0, import_ecma402_abstract4.invariant)((0, import_ecma402_abstract4.Type)(unit) === "String", "unit must be number, instead got ".concat(typeof value), TypeError);
    ...
    if (numeric === "auto") {
      if ((0, import_ecma402_abstract4.ToString)(value) in patterns) {
        return [
          {
            type: "literal",
            value: patterns[(0, import_ecma402_abstract4.ToString)(value)]
          }
        ];
      }
    }
    var tl = "future";
    if ((0, import_ecma402_abstract4.SameValue)(value, -0) || value < 0) {
      tl = "past";
    }
    var po = patterns[tl];
  ...
  var RelativeTimeFormat = function() {
    ...
    RelativeTimeFormat2.prototype.format = function(value, unit) {
      ...
      return PartitionRelativeTimePattern(this, Number(value), (0, import_ecma402_abstract5.ToString)(unit), {
        getInternalSlots: getInternalSlots
      }).map(function(el) {
        return el.value;
      }).join("");
    ...
    RelativeTimeFormat2.prototype.formatToParts = function(value, unit) {
      ...
      return PartitionRelativeTimePattern(this, Number(value), (0, import_ecma402_abstract5.ToString)(unit), { getInternalSlots: getInternalSlots });
    };
    ...
    RelativeTimeFormat2.supportedLocalesOf = function(locales, options) {
      return (0, import_ecma402_abstract5.SupportedLocales)(RelativeTimeFormat2.availableLocales, (0, import_ecma402_abstract5.CanonicalizeLocaleList)(locales), options);
    };
