(function() {
  ...
  var require_IsWellFormedCurrencyCode = __commonJS({
    "bazel-out/darwin-fastbuild/bin/packages/ecma402-abstract/IsWellFormedCurrencyCode.js": function(exports) {
      ...
      function IsWellFormedCurrencyCode3(currency) {
      ...
      exports.IsWellFormedCurrencyCode = IsWellFormedCurrencyCode3;
    }
  });
  ...
  function CanonicalCodeForDisplayNames(type, code) {
    if (type === "language") {
      return (0, import_ecma402_abstract.CanonicalizeLocaleList)([code])[0];
    }
    if (type === "region") {
    ...
    (0, import_ecma402_abstract.invariant)(type === "currency", "invalid type");
    if (!(0, import_ecma402_abstract.IsWellFormedCurrencyCode)(code)) {
  ...
  var DisplayNames = function() {
    function DisplayNames2(locales, options) {
      ...
      var requestedLocales = (0, import_ecma402_abstract2.CanonicalizeLocaleList)(locales);
      options = (0, import_ecma402_abstract2.GetOptionsObject)(options);
      var opt = /* @__PURE__ */ Object.create(null);
      var localeData = DisplayNames2.localeData;
      var matcher = (0, import_ecma402_abstract2.GetOption)(options, "localeMatcher", "string", ["lookup", "best fit"], "best fit");
      opt.localeMatcher = matcher;
      var r = (0, import_intl_localematcher.ResolveLocale)(DisplayNames2.availableLocales, requestedLocales, opt, [], DisplayNames2.localeData, DisplayNames2.getDefaultLocale);
      var style = (0, import_ecma402_abstract2.GetOption)(options, "style", "string", ["narrow", "short", "long"], "long");
      setSlot(this, "style", style);
      var type = (0, import_ecma402_abstract2.GetOption)(options, "type", "string", ["language", "currency", "region", "script"], void 0);
      if (type === void 0) {
        throw TypeError('Intl.DisplayNames constructor requires "type" option');
      }
      setSlot(this, "type", type);
      var fallback = (0, import_ecma402_abstract2.GetOption)(options, "fallback", "string", ["code", "none"], "code");
      setSlot(this, "fallback", fallback);
      setSlot(this, "locale", r.locale);
      var dataLocale = r.dataLocale;
      var dataLocaleData = localeData[dataLocale];
      (0, import_ecma402_abstract2.invariant)(!!dataLocaleData, "Missing locale data for ".concat(dataLocale));
      setSlot(this, "localeData", dataLocaleData);
      (0, import_ecma402_abstract2.invariant)(dataLocaleData !== void 0, "locale data for ".concat(r.locale, " does not exist."));
      var types = dataLocaleData.types;
      (0, import_ecma402_abstract2.invariant)(typeof types === "object" && types != null, "invalid types data");
      var typeFields = types[type];
      (0, import_ecma402_abstract2.invariant)(typeof typeFields === "object" && typeFields != null, "invalid typeFields data");
      var styleFields = typeFields[style];
      (0, import_ecma402_abstract2.invariant)(typeof styleFields === "object" && styleFields != null, "invalid styleFields data");
      setSlot(this, "fields", styleFields);
    }
    DisplayNames2.supportedLocalesOf = function(locales, options) {
      return (0, import_ecma402_abstract2.SupportedLocales)(DisplayNames2.availableLocales, (0, import_ecma402_abstract2.CanonicalizeLocaleList)(locales), options);
    };
    ...
    DisplayNames2.prototype.of = function(code) {
      ...
      var codeAsString = (0, import_ecma402_abstract2.ToString)(code);
      if (!isValidCodeForDisplayNames(type, codeAsString)) {
        throw RangeError("invalid code for Intl.DisplayNames.prototype.of");
      }
      var _a = (0, import_ecma402_abstract2.getMultiInternalSlots)(__INTERNAL_SLOT_MAP__, this, "localeData", "style", "fallback"), localeData = _a.localeData, style = _a.style, fallback = _a.fallback;
    ...
    DisplayNames2.prototype.resolvedOptions = function() {
      ...
      return (0, import_tslib.__assign)({}, (0, import_ecma402_abstract2.getMultiInternalSlots)(__INTERNAL_SLOT_MAP__, this, "locale", "style", "type", "fallback"));
    };
  ...
  function isValidCodeForDisplayNames(type, code) {
    switch (type) {
      ...
      case "currency":
        return (0, import_ecma402_abstract2.IsWellFormedCurrencyCode)(code);
    }
  }
  try {
  ...
  function getSlot(instance, key) {
    return (0, import_ecma402_abstract2.getInternalSlot)(__INTERNAL_SLOT_MAP__, instance, key);
  }
  function setSlot(instance, key, value) {
    (0, import_ecma402_abstract2.setInternalSlot)(__INTERNAL_SLOT_MAP__, instance, key, value);
  }
  ...
  function shouldPolyfill(locale) {
    ...
    if (_shouldPolyfillWithoutLocale() || !supportedLocalesOf(locale)) {
      return (0, import_intl_localematcher2.match)([locale], supportedLocales, "en");
    }
  }
