(function() {
  ...
  var require__ = __commonJS({
    "bazel-out/darwin-fastbuild/bin/packages/ecma402-abstract/262.js": function(exports) {
      ...
      exports.ToNumber = ToNumber3;
      function ToInteger(n) {
        var number = ToNumber3(n);
  ...
  function InitializePluralRules(pl, locales, options, _a) {
    ...
    opt.localeMatcher = matcher;
    internalSlots.type = (0, import_ecma402_abstract.GetOption)(opts, "type", "string", ["cardinal", "ordinal"], "cardinal");
    (0, import_ecma402_abstract.SetNumberFormatDigitOptions)(internalSlots, opts, 0, 3, "standard");
  ...
  function GetOperands(s) {
    (0, import_ecma402_abstract2.invariant)(typeof s === "string", "GetOperands should have been called with a string");
    var n = (0, import_ecma402_abstract2.ToNumber)(s);
    (0, import_ecma402_abstract2.invariant)(isFinite(n), "n should be finite");
    var dp = s.indexOf(".");
    var iv;
    var f;
    var v;
    ...
    if (dp === -1) {
      ...
      f = (0, import_ecma402_abstract2.ToNumber)(fv);
      v = fv.length;
    }
    var i = Math.abs((0, import_ecma402_abstract2.ToNumber)(iv));
    var w;
    var t;
    if (f !== 0) {
      var ft = fv.replace(/0+$/, "");
      w = ft.length;
      t = (0, import_ecma402_abstract2.ToNumber)(ft);
    } else {
      w = 0;
      t = 0;
    }
  ...
  function ResolvePlural(pl, n, _a) {
    ...
    var internalSlots = getInternalSlots2(pl);
    (0, import_ecma402_abstract3.invariant)((0, import_ecma402_abstract3.Type)(internalSlots) === "Object", "pl has to be an object");
    (0, import_ecma402_abstract3.invariant)("initializedPluralRules" in internalSlots, "pluralrules must be initialized");
    (0, import_ecma402_abstract3.invariant)((0, import_ecma402_abstract3.Type)(n) === "Number", "n must be a number");
    if (!isFinite(n)) {
      return "other";
    }
    var locale = internalSlots.locale, type = internalSlots.type;
    var res = (0, import_ecma402_abstract3.FormatNumericToString)(internalSlots, n);
  ...
  var PluralRules = function() {
    ...
    PluralRules2.prototype.resolvedOptions = function() {
      ...
      opts.pluralCategories = (0, import_tslib.__spreadArray)([], PluralRules2.localeData[opts.locale].categories[opts.type], true);
      return opts;
    };
    PluralRules2.prototype.select = function(val) {
      var pr = this;
      validateInstance(pr, "select");
      var n = (0, import_ecma402_abstract4.ToNumber)(val);
    ...
    PluralRules2.supportedLocalesOf = function(locales, options) {
      return (0, import_ecma402_abstract4.SupportedLocales)(PluralRules2.availableLocales, (0, import_ecma402_abstract4.CanonicalizeLocaleList)(locales), options);
    };
