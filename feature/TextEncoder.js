(function () {
    var hasFeature = (function(){return window.TextEncoder instanceof Function})();
    ...
    var paths = [
    "/fastestsmallesttextencoderdecoder-encodeinto@1.0.22/NodeJS/EncoderAndDecoderNodeJS.min.js"
];
    if (!isView)
